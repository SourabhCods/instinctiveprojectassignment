...
const DashBoard = () => {
  ...
  return (
    <div className='flex justify-around items-center h-screen p-[2rem]'>
      ...
      <div className='h-auto w-auto bg-stone-900/55 z-40 absolute top-48 left-15 flex justify-around p-1'>
        <img className='w-[16px] h-[16px] mt-[3.48px] ml-[1.5px] mr-[3.5px]' src={'./calendar.png'}/>
        <p className='text-stone-50'>11/02/25&nbsp;-&nbsp;03:22:55</p>
      </div>
      <div className='h-auto w-[9rem] bg-stone-900/55 z-40 absolute bottom-52 left-15 flex justify-evenly p-1'>
        <img className='w-[16px] h-[16px] mt-[3.48px] ml-[1.5px] mr-[3.5px]' src={'./video-camera.png'}/>
        <p className='text-stone-50'>{selectedIncident?.camera?.name}</p>
      </div>
